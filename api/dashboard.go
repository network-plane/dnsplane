...
<body>
  ...
  <p class="muted">JSON: <a href="/stats">/stats</a> · <a href="/stats/dashboard">Dashboard</a> · <a href="/version">/version</a> · <a href="/stats/perf">/stats/perf</a> · <a href="/stats/perf/page">Perf</a> · Prometheus: <a href="/metrics">/metrics</a> · <a href="#resolver">Resolver</a>{{if .FullStatsEnabled}} · Full stats: <a href="/stats/page?scope=total{{.StatsFullSuffix}}#full-stats">Total</a> | <a href="/stats/page?scope=session{{.StatsFullSuffix}}#full-stats">Session</a>{{end}}</p>
  <div class="grid">
